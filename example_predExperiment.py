...
with open('./dataset_label/pred_experiment.csv') as f:
    readerv = csv.reader(f)
...
pred_root = './dataset_cif'
mof = MOF_CGCNN(cuda=True,works=16, root_file=train_root,trainset = train[:1], valset=val[:1],testset=test[:1],epoch = 1,lr=0,optim='Adam',batch_size=24,h_fea_len=428,n_conv=5,lr_milestones=[160],weight_decay=5e-8,dropout=0.2)
#pred_experiment
